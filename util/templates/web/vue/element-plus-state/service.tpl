...
/**
 * @description: 修改{{table_info.table_comment}}
...
/**
 * @description: 批量修改{{table_info.table_comment}}状态
 @params {ids} number[
 ...
 * @return {Promise}
 */
export const query{{table_info.class_name}}Detail1 = async (id: number): Promise<IResponse> => {
