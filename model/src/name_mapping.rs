...
impl NameMapping {
    ...
    pub fn java_name(db_name: &str) -> String {
    ...
    pub fn jdbc_name(db_name: &str) -> String {
        let mut map = HashMap::new();
    ...
    pub fn rust_name(db_name: &str) -> String {
        let mut map = HashMap::new();
    ...
    pub fn go_name(db_name: &str) -> String {
        let mut map = HashMap::new();
    ...
    pub fn ts_name(db_name: &str) -> String {
        let mut map = HashMap::new();
    ...
    pub fn proto_name(db_name: &str) -> String {
        let mut map = HashMap::new();
