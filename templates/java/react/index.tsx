...
React.FC = () => {
    ...
    const [{{table_name}}ListData, set{{class_name}}ListData] = useState < {
    {
        class_name
    }
}
    Vo[] > ([]);
    const [current{{class_name}}, setCurrent{{class_name}}] = useState < {
    {
        class_name
    }
}
...
,
    ...
    const handleSearchOk = async (user: {
    {
        class_name
    }
}
    ...
    <div style={{padding: 24}}>
        ...
        <UpdateForm onCancel={handleEditCancel} onCreate={handleEditOk} open={isShowEditModal} {{table_name}}
                    Vo={current{{class_name}}}></UpdateForm>
